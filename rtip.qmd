...
This next chart is just an example of how one might facet these charts to display data a little differently. You can, of course, have multiple circles that all display data and charts, however for this example I choose to just play with their colors and brightness.
